...
def main(dataset, augment=False, use_scattering=False, size=None,
    ...
    for epoch in range(0, epochs):
        ...
        train_loss, train_acc = train(model, train_loader, optimizer, n_acc_steps=n_acc_steps, max_physical_batch_size=max_physical_batch_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_physical_batch_size', type=int, default=512)
